...
class InfoActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var pageLabel = findViewById<TextView>(R.id.infoLabel)
        var msg1 = findViewById<TextView>(R.id.groceryInfo1)
        var msg2 = findViewById<TextView>(R.id.groceryInfo2)
        var msg3 = findViewById<TextView>(R.id.groceryInfo3)
        var msg4 = findViewById<TextView>(R.id.groceryInfo4)
        var msg5 = findViewById<TextView>(R.id.groceryInfo5)
        var msg6 = findViewById<TextView>(R.id.groceryInfo6)
        var msg7 = findViewById<TextView>(R.id.groceryInfo7)
        var msg8 = findViewById<TextView>(R.id.groceryInfo8)
        var msg9 = findViewById<TextView>(R.id.groceryInfo9)
